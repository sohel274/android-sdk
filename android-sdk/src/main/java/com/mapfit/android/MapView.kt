...
class MapView(
    ...
    private fun initUiControls() {
        ...
        btnCompass.setOnClickListener {
            launch {
                ...
                mapController.setRotationEased(0f, ANIMATION_DURATION, mapController.DEFAULT_EASE_TYPE)
            }
        }
    ...
    private fun setZoomOnDoubleTap(x: Float, y: Float) {
        ...
        mapController.setPositionEased(lngLat, ANIMATION_DURATION, mapController.DEFAULT_EASE_TYPE, false)
